...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.recto.card.game.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.recto.card.game.security.DomainUserDetailsService", "createSpringSecurityUser");
