package com.recto.card.game.web.rest;

import com.recto.card.game.config.Constants;
import com.recto.card.game.domain.User;
import com.recto.card.game.repository.UserRepository;
import com.recto.card.game.security.AuthoritiesConstants;
import com.recto.card.game.service.MailService;
import com.recto.card.game.service.UserService;
import com.recto.card.game.service.dto.AdminUserDTO;
import com.recto.card.game.web.rest.errors.BadRequestAlertException;
import com.recto.card.game.web.rest.errors.EmailAlreadyUsedException;
import com.recto.card.game.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.recto.card.game.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
